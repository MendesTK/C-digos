...
public class AdicionarProdutos {
	...
	public static void main(String[] args) {
		...
		view.print(produtosPrecoOrdenadoDecrescente, "Produtos ordenados por preços decrescente");
				
		List<Produto> produtosPrecoOrdenadoCrescente = ordenarPreco.ordenarCrescente(produtos);
		view.print(produtosPrecoOrdenadoCrescente, "Produtos ordenados por preços crescente");
